  ...
  return (
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent className="max-w-sm dark:bg-dark-surface dark:border-dark-border">
        <AlertDialogHeader>
          <AlertDialogTitle className="dark:text-white">{t.deleteListTitle}</AlertDialogTitle>
          <AlertDialogDescription className="dark:text-gray-300">
            {t.deleteListDesc.replace("{name}", listName)}
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
          ...
          <AlertDialogAction onClick={onConfirm} className="bg-red-600 hover:bg-red-700 text-white border border-red-700 dark:border-red-500 shadow-sm">
            {t.delete}
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
